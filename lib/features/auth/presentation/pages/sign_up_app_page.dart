    ...
    return Scaffold(
      body: Stack(
        children: [
          SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                ...
                addVerticalSpace(30),
                const Text("Regístrate", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 40), textAlign: TextAlign.center),
                addVerticalSpace(30),
                const Text(
          ...
          Positioned.fill(
            child: Obx(() => controller.signUpState.value == LoadingState.loading
                ? Container(
